...
def registrar_viaje_bloqueo(usuario_actual):
    ...
    cursor.execute("""
        INSERT INTO ventas (
            cliente, tipo_venta, destino, fecha_inicio, fecha_fin, noches,
    ...
    """, (
        cliente, "Bloqueo", bloqueo['hotel'], bloqueo['fecha_inicio'], bloqueo['fecha_fin'], noches,
...
def registrar_viaje_normal(usuario_actual):
    ...
    """, (
        cliente, "General", destino, fecha_inicio, fecha_fin, noches,
        adultos, menores, tipo_habitacion, precio_adulto, precio_menor, precio_total,
        porcentaje_ganancia, ganancia, costo_mayorista, saldo, "ACTIVO",
        id_vendedora, usuario_actual["id_vendedora"], fecha_registro
    ))
    ...
    if usuario_actual["rol"] == "VENDEDORA":
        cursor.execute("""
            SELECT v.id, v.cliente, v.destino, v.fecha_inicio, v.fecha_fin,
                   ...
                   v.comision_vendedora, v.comision_pagada
            FROM ventas v
